...
<body>
    ...
    <div class="container cont">
        ...
        <div class="row">
            ...
            <div class="hidden-xs">
                <?php include ('sidebar-populer.php') ?>
            </div>
                    ...
                    <div class="visible-xs hidden-lg hidden-md hidden-sm">
                        <section class="box-network bottom-15">
                            ...
                            <ul class="todo list-unstyled font-weight-bold">
                                <li>
                                    <a href="detail-artikel.php"><span class="todo-number">1</span>Gus Margiono</a>
                                </li>
                                <li>
                                    <a href="detail-artikel.php"><span class="todo-number">2</span>Imlek Pandemi</a>
                                </li>
                                <li>
                                    <a href="detail-artikel.php"><span class="todo-number">3</span>Sesal Istri</a>
                                </li>
                                <li>
                                    <a href="detail-artikel.php"><span class="todo-number">4</span>Kuda Bima</a>
                                </li>
                                <li>
        ...
        <div class="row">
            ...
            <div class="hidden-xs">
                <?php include ('sidebar-pilihan.php') ?>
            </div>
        ...
        <div class="row">
            <div class="label-to bottom-10 content-wrap align-center justify-content-between p-horizontal-15">
                <h2>Foto</h2>
                <p><a href="foto.php">Lihat Semua <i class="fa fa-chevron-right"></i></a></p>
            </div>
            <section class="black-box box-middle thumb-ito bottom-15">
                <div class="slide-vid-pic owl-carousel owl-theme">
                    <div class="item">
                    ...
                    <div class="bottom-15">
                        <section>
                            ...
                            <div class="bottom-30 text-center">
                                <h3 class="btn btn-default border-red-outline btn-lg"><a href="indeks-page.php"
                                        class="red-color">Indeks</a></h3>
                            </div>
        ...
        <div class="visible-xs hidden-lg hidden-md hidden-sm">
            ...
            <section class="grid bottom-15">
                <div class="label-featured text-uppercase text-center">
                    <h2 class="">Happy Wednesday</h2>
                </div>
                <div class="block-featured">
                    <div class="owl-carousel slide-featured owl-theme">
                        <div class="item">
                            <div class="frame-featured">
                                <a href="#">
                                    <img src="img/thumb1.jpg" alt="">
                                    <div class="caption">Prinsip Liga Pandemi</div>
                                </a>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            <div class="frame-featured">
                                <a href="#">
                                    ...
                                    <div class="caption">Peacemaker Wkwk</div>
                                </a>
                            </div>
                        </div>
                        <div class="item">
